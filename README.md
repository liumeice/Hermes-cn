...
Scrape the [Hermes Agent Chinese documentation](https://hermes-agent.nousresearch.com/docs/zh-Hans/) and produce a single merged PDF (`Output/HermesAgent-docs.pdf`) with full bookmark/TOC structure.
